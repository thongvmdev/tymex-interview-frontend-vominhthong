...
const initialValues = { title: '', createAtOrder: 'asc', priceSortOrder: 'desc', tier: '', theme: '', price: [0, 200] }
  ...
  return (
    ...
    >
      ...
      <Form.Item<FieldType> className={formFilterSearchStyles.formItem} name='priceSortOrder' label='PRICE'>
        <Select className={formFilterSearchStyles.formSelect} options={priceSortOpts} />
      </Form.Item>
